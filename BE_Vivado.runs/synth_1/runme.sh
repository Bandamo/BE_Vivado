...
HD_PWD='D:/BE_Vivado/BE_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Antibounce.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Antibounce.tcl
