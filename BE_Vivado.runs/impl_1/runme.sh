...
HD_PWD='D:/BE_Vivado/BE_Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Antibounce.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Antibounce.tcl -notrace
